...
nextButton.addEventListener('click', () => {
	...
	moneyArray[moneyIdx].style.backgroundColor = "mediumblue";
	moneyArray[moneyIdx+1].style.backgroundColor = "transparent";
...
let moneyIdx = moneyArray.length - 1;
let delay = 9050;
...
function setStatusClass(correct) {
    Array.from(answerButtonsElement.children).forEach(button => {
        if (!button.classList.contains('selected')) {
            if (shuffledQuestions[currentQuestionIndex].answers.find(answers => { return answers.text === button.textContent }).correct) {
    ...
    if (correct) {
        ...
        if (moneyIdx >= 0) {
            ...
            setTimeout(function () { moneyArray[moneyIdx+1].style.backgroundColor = "green"; }, 1850);
            ...
            setTimeout(function () { moneyArray[moneyIdx+1].style.backgroundColor = "green"; resetState(); questionElement.innerText = 'Congratulations, you are a millionaire!'; restartButton.style.display = "block"; }, 5000);
        }

    } else {
        // element.classList.add('wrong')
        setTimeout(function () { moneyArray[Math.max(0, moneyIdx - 1)].style.backgroundColor = "transparent"; moneyArray[moneyIdx].style.backgroundColor = "crimson"; }, 1850);
        setTimeout(function () { answerButtonsElement.style.display = "none"; }, 5000);
        setTimeout(function () { questionContainer.style.display = "none"; }, 5000);
